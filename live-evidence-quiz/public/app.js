  ...
  views.quiz.innerHTML = `
    <div class="hero-row">
      ...
      <div class="panel stat-grid" aria-label="Quiz summary">
        ...
        <div class="stat"><span>Auto short answers</span><strong>${shortCount}</strong></div>
      </div>
    </div>
    <form id="quizForm" class="question-list">
      ${state.questions.map(renderQuestion).join("")}
      <div class="panel">
        <p class="helper">${autoCount} choice questions and ${shortCount} short-answer questions are scored automatically.</p>
        <div class="actions">
