...
Mobile-first live quiz system for a 25-question competition.
...
- Short-answer questions are scored automatically by word count and keyword matches.
...
- 10 or more words: 1 point
- Keyword/action matches: up to 3 points
- A long answer without relevant keywords can only receive 1 point
- Full marks require matching all key action groups, so full marks should not be awarded lightly

You can edit the keyword groups in `public/questions.json`.
